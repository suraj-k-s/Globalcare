...
<head>
    ...
    <link rel="stylesheet" href="Assets/Template/css/gijgo.css">
    <link rel="stylesheet" href="Assets/Template/css/animate.css">
    <link rel="stylesheet" href="Assets/Template/css/slicknav.css">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-envelope"></i> globalcareteam@gmail.com</a></li>
                                    <li><a href="#"> <i class="fa fa-phone"></i>  04852850641</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-2">
                            <div class="logo">
                                <a href="#">
                                    <img src="Assets/icon.jpg" alt="" width="150" height="150"><font color="Blue">GLOBAL CARE</font>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="Guest/user.jsp">New User</a></li>
                                          <li><a href="Guest/hospitalreg.jsp">New Hospital</a></li>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6">
                    <div class="welcome_thumb">
                        <div class="thumb_1">
                            <img src="Assets/Template/img/about/1.png" alt="">
                        </div>
                        <div class="thumb_2">
                            <img src="Assets/Template/img/about/2.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="Assets/Template/img/department/1.png" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="Assets/Template/img/department/2.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="Assets/Template/img/department/3.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="Assets/Template/img/department/4.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="Assets/Template/img/department/5.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="Assets/Template/img/department/6.png" alt="">
                        </div>
                        <div class="department_content">
                                    ...
                                    <div class="row align-items-center">
                                            ...
                                            <div class="col-xl-6 col-md-6">
                                                <div class="business_thumb">
                                                    <img src="Assets/Template/img/about/business.png" alt="">
                                                </div>
                                            </div>
                                        </div>
                            </div>
                    ...
                    <div class="expert_active owl-carousel">
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="Assets/Template/img/experts/1.png" alt="">
                            </div>
                        ...
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="Assets/Template/img/experts/2.png" alt="">
                            </div>
                            <div class="experts_name text-center">
                                <h3>Mirazul Alom</h3>
                                <span>Neurologist</span>
                        ...
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="Assets/Template/img/experts/3.png" alt="">
                            </div>
                            <div class="experts_name text-center">
                                <h3>Mirazul Alom</h3>
                                <span>Neurologist</span>
                        ...
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="Assets/Template/img/experts/4.png" alt="">
                            </div>
                            <div class="experts_name text-center">
                                <h3>Mirazul Alom</h3>
                                <span>Neurologist</span>
                        ...
                        <div class="col-xl-4 col-md-6 col-lg-4">
                            <div class="footer_widget">
                                <div class="footer_logo">
                                    <a href="#">
                                        <img src="Assets/Template/img/footer_logo.png" alt="">
                                    </a>
                                </div>
                                <p>
...
<!-- footer end  -->
    ...
    <script src="Assets/Template/js/gijgo.min.js"></script>
    <!--contact js-->
    <script src="Assets/Template/js/contact.js"></script>
    <script src="Assets/Template/js/jquery.ajaxchimp.min.js"></script>
    <script src="Assets/Template/js/jquery.form.js"></script>
    <script src="Assets/Template/js/jquery.validate.min.js"></script>
    <script src="Assets/Template/js/mail-script.js"></script>
