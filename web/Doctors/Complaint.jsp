    ...
    <body>
        ...
        <div id="tab">
         <%
            ...
            {
                  {
                String ins="insert into tbl_complaint(complaint_title,complaint_date,doctor_id,complaint_content,complainttype_id)values('"+request.getParameter("txtitle")+"',curdate(),'"+session.getAttribute("doctorid")+"','"+request.getParameter("txtcmp")+"','"+request.getParameter("sclcpmlt")+"')"; 
               out.println(ins);
