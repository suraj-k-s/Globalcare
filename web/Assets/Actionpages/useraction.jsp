<%-- 
    Document   : useraction
    Created on : 8 Feb, 2022, 2:16:33 PM
    Author     : rinus
--%>
...
//                        }
           ...
           //to upload proof of doctor
                ...
                {
               String InsQry = "insert into tbl_user(user_name,user_email,user_contact,user_address,place_id,user_gender,user_photo,user_pswrd,user_doj)values('"+value[0]+"','"+value[1]+"','"+value[2]+"','"+value[3]+"','"+value[5]+"','"+value[6]+"','"+photo+"','"+value[7]+"',curdate())";
                ...
                if (status == true) {
                        ...
                        pid="PID"+randomNumber;
                        
                      String selmax="select max(user_id)as uid from tbl_user";
                      ResultSet rsmax=obj.selectCommand(selmax);
                      if(rsmax.next())
                      {
                          String up="update tbl_user set user_pid='"+pid+"' where user_id='"+rsmax.getString("uid")+"'";
