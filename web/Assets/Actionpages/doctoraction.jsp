<%-- 
    Document   : doctoraction
    Created on : 10 Feb, 2022, 1:29:26 PM
    Author     : rinus
--%>
...
//                        }
           ...
           //to upload proof of doctor
               ...
               String InsQry = "insert into tbl_doctors(doctors_name,doctors_contact,doctors_email,doctors_gender,doctors_address,place_id,hospital_id,doctors_photo,department_id,doctors_qualification,doctors_pswrd,doctors_doj)values('"+value[0]+"','"+value[1]+"','"+value[2]+"','"+value[3]+"','"+value[4]+"','"+value[6]+"','"+ session.getAttribute("hospitalid")+"','"+photo+"','"+value[7]+"','"+value[8]+"','"+value[9]+"',curdate())";
               out.println(InsQry);
