<%-- 
    Document   : MedicalReportAction
    Created on : 12 Mar, 2022, 3:56:21 PM
    Author     : rinus
--%>
...
//                        }
           ...
           //to upload proof of doctor
               ...
               String InsQry = "insert into tbl_medicalreport(cd_id,mr_title,mr_remark,mr_medicine,mr_ismajor,mr_majordetails,mr_report)values('"+session.getAttribute("consultancyid")+"','"+value[0]+"','"+value[1]+"','"+value[2]+"','"+value[3]+"','"+value[4]+"','"+photo+"')";
               out.println(InsQry);
   //System.out.println(InsQry);
                ...
                if (status == true) {
                     String up="update tbl_cdetails set cd_status=2 where cd_id='"+session.getAttribute("consultancyid")+"'";
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Doctors/ViewConsultancyBooking.jsp';
