<%-- 
    Document   : Consultancyaction
    Created on : 18 Feb, 2022, 11:14:28 AM
    Author     : rinus
--%>
...
//                        }
           ...
           //to upload proof of doctor
               ...
               String InsQry = "insert into tbl_consultancy(consultancy_name,hospital_id,consultancy_head,consultancy_logo,consultancy_password)values('"+value[0]+"','"+ session.getAttribute("hospitalid")+"','"+value[1]+"','"+photo+"','"+value[2]+"')";
   //System.out.println(InsQry);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Hospital/ConsultancyRegistration.jsp';
