    ...
    <body>
        ...
        if(request.getParameter("btnedit")!=null)
             {  
                    ...
                    String up="Update tbl_user set user_name='"+request.getParameter("txtname")+"',user_contact='"+request.getParameter("txtcontact")+"',user_email='"+request.getParameter("txtemail")+"',user_address='"+request.getParameter("txtaddr")+"' where user_id='"+session.getAttribute("userid")+"'";
