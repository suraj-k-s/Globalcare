...
<html>
    ...
    <body>
        ...
        <%
            ...
            {
                {
                String ins="insert into tbl_feedback(feedback_description,feedback_date,user_id)values('"+request.getParameter("txtfdbk")+"',curdate(),'"+session.getAttribute("userid")+"')"; 
               out.println(ins);
